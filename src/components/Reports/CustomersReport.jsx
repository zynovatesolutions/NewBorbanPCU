...
const branchLogo = "/GoldenPCU.svg";
...
const columns = CustomerColumns.filter(
    (col) => col.id !== "actions" && col.id !== "branchId"
  );
    ...
    <div className="flex flex-col items-center justify-center pb-10">
      ...
      >
        ...
        <div className="mt-4 overflow-hidden rounded-lg border border-slate-200">
          <PrintSimpleTable rows={CustomerState.data} columns={columns} />
        </div>
      </div>
    </div>
  );
